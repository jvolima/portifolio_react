...
const lunaBus = {
  title: 'Luna Bus',
  description: 'Site para o transporte público de cidades de pequeno e médio porte.',
  techs: [
    'React',
    'Next',
    'TypeScript',
...
const jvBox = {
  title: 'JvBox',
  description: 'Site parecido com o Dropbox, onde você pode se cadastrar e salvar suas imagens e gifs favoritos.',
  techs: [
    'Java',
    'Ajax',
    'JavaScript',
